...
# using `environment.prod.ts`
ionic cordova build android --prod --release

cat build-data/keystores/${1}.password | jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore build-data/keystores/${1}.keystore  platforms/android/app/build/outputs/apk/release/app-release-unsigned.apk $1
